...
class License extends AbstractDataType implements IGenericDataType, IComposerComponent {
    ...
    const NONE = null;
    const APACHE2_0 = 'Apache-2.0';
    const BSD2_CLAUSE = 'BSD-2-Clause';
    const BSD3_CLAUSE = 'BSD-3-Clause';
    const BSD4_CLAUSE = 'BSD-4-Clause';
    const GPL2_0_ONLY = 'GPL-2.0-only / GPL-2.0-or-later';
    const GPL3_0_ONLY = 'GPL-3.0-only / GPL-3.0-or-later';
    const LGPL2_1_ONLY = 'LGPL-2.1-only / LGPL-2.1-or-later';
    const LGPL3_0_ONLY = 'LGPL-3.0-only / LGPL-3.0-or-later';
    const MIT = 'MIT';
    ...
    static function availableLicenses(): array {
        return [
            self::APACHE2_0,
            self::BSD2_CLAUSE,
            self::BSD3_CLAUSE,
