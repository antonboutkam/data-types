 ...
 * @package Hurah\Type
 */
class PrimitiveInt extends AbstractDataType implements IGenericDataType, IPrimitiveType
{
    ...
    function __construct($sValue = null) {
        ...
        if ($sValue !== null)
        {
            throw new InvalidArgumentException(__CLASS__ . " cannot hold any other value then \"int\".");
        }
